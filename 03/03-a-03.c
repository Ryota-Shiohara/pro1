...
in hoe(y): y? 101
O
in main after calling hoe(y): y? 100
O
in foo(y): x? 300
O
in foo(y): y? 101
...
in hoe(y): y? 101
O
in main after calling hoe(y) again: y? 100
O
*/
...
int main()
{
    ...
    hoe(y);
    printf("in main after calling hoe(y): y? ");
    check_answer(y);
    ...
    hoe(y);
    printf("in main after calling hoe(y) again: y? ");
    check_answer(y);
